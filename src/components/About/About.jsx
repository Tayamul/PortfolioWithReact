  ...
  return (
    <section id="about">
      <div id="about-summary">
        ...
        <h1>Autonomous Programmer based in London, UK 📍</h1>
        <p>
        ...
        <p>
          Currently, I am a Software Engineering Intern focused on creating a
          SaaS platform by engaging and collaborating with a cross-functional
          team.
        </p>
        <p>
